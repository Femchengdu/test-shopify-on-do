        ...
        <Stack vertical>
            ...
            <Layout>
                    ...
                    <Form>
                        ...
                        <FormLayout>
                            ...
                            >
                                ...
                                <Card.Section title="More NFT campaign info 1">
                                    <p>#TODO Additional campaign informations</p>
                                </Card.Section>
                            </Card>
                            <Card
                                sectioned
                                title="More NFT campaign info 2"
                                actions={[
                                    {
                                        content: "Todo upload bulk discount codes????",
                                        onAction: () => {

                                            /**
                                             * You can use this to navigate
                                             * navigate(
                                                {
                                                    name: "Discount",
                                                    resource: {
                ...
                <Layout.Section secondary>
                    <Card sectioned title="NFT campaign">
                        {QRCode ? (
                            <EmptyState imageContained={true} image={QRCodeURL} />
                        ) : (
                            <EmptyState>
                                <p>Your NFT campaign info will appear here after you save.</p>
                            </EmptyState>
                        )}
                        <Stack vertical>
                            <Button
